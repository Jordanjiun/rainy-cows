...
const manifest = {
  bundles: [
    ...
    },
    {
      name: 'others',
      assets: [
        { alias: 'farmbarn', src: '/assets/others/barn.png' },
        ...
        { alias: 'fence', src: '/assets/others/fence.png' },
        { alias: 'plant', src: '/assets/others/plant.png' },
        { alias: 'totem', src: '/assets/others/totem.png' },
      ],
    },
  ],
};
